...
var appSettingsValidationResult = appSettings.Validate();

if (!appSettingsValidationResult.IsValid)
{
    Console.WriteLine("AppSettings is invalid");
    foreach (var message in appSettingsValidationResult.Messages)
